    ...
    <footer className="mt-auto border-t border-border-subtle bg-bg-surface/50 backdrop-blur-lg pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col">
            <Link href="/" className="mb-6 inline-block group">
              <Image
                ...
                width={160}
                height={160}
                className="group-hover:opacity-90 transition-opacity duration-300 dark:hidden"
              />
              <Image
                ...
                width={160}
                height={160}
                className="group-hover:opacity-90 transition-opacity duration-300 hidden dark:block"
              />
            </Link>
            <p className="text-text-muted text-sm leading-relaxed max-w-xs">
              Food delivery built in Lebanon, for Lebanon. <br/>
              Order from local restaurants, track your driver live, and pay cash at your door.
            </p>
          </div>

          <div>
            <h4 className="text-text-main font-semibold text-sm uppercase tracking-wider mb-6">Company</h4>
          ...
          <div>
            <h4 className="text-text-main font-semibold text-sm uppercase tracking-wider mb-6">Support</h4>
            <ul className="space-y-4">
              <li>
          ...
          <div>
            <h4 className="text-text-main font-semibold text-sm uppercase tracking-wider mb-6">Download</h4>
            <ul className="space-y-4">
              <li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border-subtle gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="https://www.instagram.com/nowlnylb" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-text-main transition-colors duration-300">
            ...
            <Link href="https://www.facebook.com/profile.php?id=61589544729149" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-text-main transition-colors duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
