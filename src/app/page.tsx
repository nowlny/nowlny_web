      ...
      <section className="hero">
        <div className="container hero-grid">
          <div className="hero-content slide-up">
            ...
            <p>
              Nowlny is your premium food delivery partner. Get your favorite meals from top restaurants delivered fast and fresh to your doorstep.
            </p>
        ...
        <div className="container">
          <div className="hero-grid" style={{ alignItems: 'center' }}>
            ...
            <div className="hero-content">
              ...
              <p>
                Our app is designed to be intuitive and beautiful. Browse menus, customize your orders, and track your delivery in real-time.
              </p>
              <ul style={{ listStyle: 'none', marginBottom: '2rem' }}>
                <li style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ color: 'var(--accent)', fontWeight: 'bold' }}>✓</span> Real-time order tracking
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ color: 'var(--accent)', fontWeight: 'bold' }}>✓</span> Personalized recommendations
                </li>
                <li style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ color: 'var(--accent)', fontWeight: 'bold' }}>✓</span> 24/7 customer support
                </li>
              </ul>
      ...
      <section className="section" style={{ backgroundColor: 'var(--bg-secondary)', textAlign: 'center' }}>
        <div className="container">
          ...
          <div className="store-buttons" style={{ justifyContent: 'center' }}>
            <Link href="/" className="store-btn" style={{ backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)', borderColor: 'var(--border-color)' }}>
              <div className="store-btn-text">
                <span>Download on the</span>
                <strong>App Store</strong>
              </div>
